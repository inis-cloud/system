!function (t) {
    ...
    const app = Vue.createApp({
        ...
        mounted() {
            ...
            this.default_ico    = '/admin/svg/filesystem/other.svg'
        },
        methods: {
            
            // 获取数据
            initData(name = '', type = false, load = false){
                
                if (load) this.loading.init_data = true
                ...
                axios.post('/admin/file/getDir', params).then(res=>{
                    if (res.data.code == 200) {
                        const result  = res.data.data
                        this.dir_info = result
            ...
            dblclick(name = this.mouse_menu.file_name, type = this.mouse_menu.type){
                ...
                if (type == 'file') {
                    ...
                    axios.post("/admin/file/read", params).then(res=>{
                        if (res.data.code == 200) {
            ...
            editName(){
                ...
                axios.post('/admin/file/editName', params).then(res=>{
                    if (res.data.code == 200) this.initData()
                })
            },
            ...
            viewDetails(){
                ...
                if (inisHelper.is.empty(this.edit_data)) this.edit_data = {'ico':'/admin/svg/filesystem/system.svg','file_name':'当前目录'}
                ...
                axios.post('/admin/file/fileInfo', params).then(res=>{
                    if (res.data.code == 200) {
            ...
            addFile(){
                ...
                axios.post('/admin/file/addFile', params).then(res=>{
                    if (res.data.code == 200) {
                        this.initData()
                        this.add_file_name = ''
                        $.NotificationApp.send(null, "创建成功！", "top-right", "rgba(0,0,0,0.2)", "success");
                    }
                })
            },
            ...
            delFile(){
                ...
                axios.post('/admin/file/delFile', params).then(res=>{
                    if (res.data.code == 200) {
                        this.initData()
            ...
            setIco(file){
                ...
                // 文件图片路径
                const path = '/admin/svg/filesystem/'
            ...
            uploads(item){
                ...
                axios.post("/admin/file/uploadFileOne", params, config).then(res =>{
                    // 后端确认保存成功了
            ...
            saveEditFile(){
                ...
                axios.post("/admin/file/write", params).then(res=>{
                    if (res.data.code == 200) {
            ...
            // 复制文件链接
            copyLink(){
                const url    = this.parseFileUrl(this.mouse_menu.path_name)
                const result = inisHelper.set.copy.text(url)
                if (result) $.NotificationApp.send(null, "文件链接已复制！", "top-right", "rgba(0,0,0,0.2)", "success")
                else $.NotificationApp.send(null, "复制失败！", "top-right", "rgba(0,0,0,0.2)", "warning")
            },
            // 解析文件外链地址
            parseFileUrl(url = ''){
                // 当前域名
        ...
        watch: {
            ...
            loading: {
                handler(newValue, oldValue){
                    const self = this
                    if (self.loading.read_file) $.NotificationApp.send(null, "正在读取文件内容 ...", "top-right", "rgba(0,0,0,0.2)", "success");
                },
                deep: true,
            },
        }
