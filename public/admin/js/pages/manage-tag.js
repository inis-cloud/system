    ...
    const app = Vue.createApp({
        ...
        methods: {
            ...
            initData(id = '', page = this.page, is_load = false){
                ...
                axios.post('/admin/ManageTag', params).then((res) => {
                    if(res.data.code == 200){
                        ...
                        // 页码列表
                        this.page_list         = inisHelper.create.paging(page, this.tag_data.page, 5)
            ...
            btnSave(id){
                ...
                if(inisHelper.is.empty(this.edit.name)){
                    $.NotificationApp.send(null, "请填写标签名称！", "top-right", "rgba(0,0,0,0.2)", "warning");
                }else{
                    ...
                    axios.post('/admin/method/SaveTag', params).then((res) => {
                        if(res.data.code == 200){
            ...
            btnDelete(id = ''){
                ...
                axios.post('/admin/method/DeleteTag', params).then((res) => {
                    if(res.data.code == 200){
            ...
            isShow(id = ''){
                ...
                axios.post('/admin/handle/SetTagShow', params)
            },
        }
    }).mount('#manage-tag')
