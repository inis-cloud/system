    ...
    const app = Vue.createApp({
        ...
        methods: {
            ...
            initData(id = '', page = this.page, is_load = false){
                ...
                axios.post('/index/ManageUsers', params).then((res) => {
                    if (res.data.code == 200) {
                        ...
                        // 页码列表
                        this.page_list         = inisHelper.create.paging(page, this.users.page, 7)
            ...
            save(){
                ...
                // } else 
                if (factor2) {
                    $.NotificationApp.send("错误！", "昵称不能为空！", "top-right", "rgba(0,0,0,0.2)", "warning");
                } else if (factor3) {
                    $.NotificationApp.send("错误！", "邮箱不能为空！", "top-right", "rgba(0,0,0,0.2)", "warning");
                } else if (!factor4) {
                    $.NotificationApp.send("错误！", "邮箱格式错误！", "top-right", "rgba(0,0,0,0.2)", "warning");
                } else {
                    ...
                    axios.post('/index/method/SaveUsers', params).then((res) => {
                        if (res.data.code == 200) {
                            // 刷新数据
                            this.initData()
                            // 关闭 model 窗口
            ...
            isEnable(id){
                ...
                axios.post('/index/handle/SetUserEnable', params).then((res) => {
            ...
            deleteUsers(id = ''){
                ...
                axios.post('/index/method/deleteUsers', params).then(res=>{
                    if (res.data.code == 200) {
